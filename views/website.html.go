...
<p>No need for any <strong><code>npm install ...</code></strong> which can easily cause the local <strong><code>node_modules</code></strong> folder to exceed 100 MB of size when using frameworks like React.
<img src="./assets/website/node-modules.png" alt="Node Modules"><!-- class="mx-auto h-full" --></p>
<br>
